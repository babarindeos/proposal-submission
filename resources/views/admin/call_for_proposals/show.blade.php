<x-admin-layout>
    ...
    <div class="flex flex-col border-0 border-red-900 w-full">
        ...
        <section class="py-8 mt-2">
                <div>
                    <form  action="# " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
    
                        
    
                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >Call for Proposals</h2>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-2">
                                            ...
                                            accept=".jpg, .jpeg, .png"
                                            />
                                           @if ($call_for_proposal->advert != null)
                                                <div class='text-sm'>
                                                    <a href="{{ asset('storage/'.$call_for_proposal->advert) }}" target="_blank" class="text-blue-600 hover:underline">View Current Advert</a>  
                                                </div>
                                           @endif
